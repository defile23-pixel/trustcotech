...
const Welcome = ({ user, stage, onActivate }) => {
  const steps = [
    { n: "01", ic: "key", t: "Receive Partner ID", d: "Our admin issues a unique Partner ID to your account within 10 mins." },
    { n: "02", ic: "sync", t: "Connect", d: "Enter the Partner ID to connect to your partner device." },
    { n: "03", ic: "cart", t: "Choose Your Plan", d: "Select a subscription that fits your needs and complete payment via your preferred method, to instantly access calls, messages, location and more." },
  ];
...
const AdminDash = ({ user, setUser, sp }) => {
  ...
  const DEFAULT_SITE_CONTENT = {
    hero_badge: "Premium Phone To Phone Sync Technology",
    hero_title_line1: "Your Phones.",
    hero_title_line2: "One Seamless Connection.",
    hero_subtitle: "Forward calls, messages, WhatsApp, Instagram, Facebook, photos, videos, contacts and live location from your primary phone to any secondary device — in real time.",
    cta_title: "Ready to sync your partner phones?",
    cta_subtitle: "Create a free account and get your admin-issued Partner ID to start syncing your partner devices.",
    ...
    <div>
      ...
      <section className="sec"><div className="ct">
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(270px,1fr))", gap: 22 }}>
          {[{ n: "01", ic: "key", cl: GOLD, t: "Receive Partner ID", d: "Our admin issues a unique Partner ID to your account within 10 mins." }, { n: "02", ic: "link", cl: SILVER, t: "Connect", d: "Enter the Partner ID to connect to your partner device." }, { n: "03", ic: "credit", cl: GOLD, t: "Choose Your Plan", d: "Select a subscription that fits your needs and complete payment via your preferred method, to instantly access calls, messages, location and more." }].map(s => (
      ...
      <section style={{ padding: "56px 0", borderTop: "1px solid rgba(201,168,76,0.1)", borderBottom: "1px solid rgba(201,168,76,0.1)" }}><div className="ct"><div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(150px,1fr))", gap: 36, textAlign: "center" }}>{[["1.2K+", "Active Users"], ["99.9%", "Sync Uptime"], ["< 20s", "Sync Delay"], ["12", "Data Streams"]].map(([v, l]) => (<div key={l}><p className="raj grad-gold" style={{ fontSize: 42, fontWeight: 700, marginBottom: 7 }}>{v}</p><p style={{ color: MUTED, fontSize: 13 }}>{l}</p></div>))}</div></div></section>
