...
const PayModal = ({ onClose, onOk, user, token }) => {
  ...
  // Pull admin-configured WhatsApp/Facebook support links so this stays in
  // sync with whatever is set in Admin → Settings.
  useEffect(() => {
      ...
      <div style={{ minHeight: "calc(100vh - 70px)", display: "flex", alignItems: "center", justifyContent: "center", padding: "24px 20px" }}>
        <div style={{ width: "100%", maxWidth: 460 }}>
          <div className="glass au" style={{ padding: "44px 28px", textAlign: "center" }}>
            ...
            <h2 className="raj" style={{ fontSize: 22, fontWeight: 700, marginBottom: 10 }}>Payment Submitted</h2>
            <p style={{ color: MUTED, fontSize: 13.5, lineHeight: 1.7, marginBottom: 22 }}>
              Please wait while the admin confirms your payment. Once confirmed, your account will be activated automatically and you'll be redirected here.
            </p>
