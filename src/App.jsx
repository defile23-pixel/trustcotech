    ...
    <div className="dash-layout" style={{ paddingTop: 70, display: "flex", minHeight: "100vh" }}>
      ...
      <div className="main-scroll" style={{ flex: 1, padding: "32px 28px", overflow: "auto" }}>
        ...
        {tab === "users" && (
          ...
          {/* Edit User Modal */}
          {editUser && (
            <div className="mo" style={{ zIndex: 99999, position: "fixed", inset: 0, background: "rgba(0,0,0,0.7)", display: "flex", alignItems: "center", justifyContent: "center", padding: 16, overflowY: "auto" }} onClick={() => setEditUser(null)}>
